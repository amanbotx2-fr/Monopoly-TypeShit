...
export function tileRect(pos) {
	...
	if (pos === 10)
		return { left: 100 - C, top: 0, width: C, height: C, side: 'corner', corner: 'tr' };
	if (pos === 20)
		return { left: 100 - C, top: 100 - C, width: C, height: C, side: 'corner', corner: 'br' };
	if (pos === 30)
		return { left: 0, top: 100 - C, width: C, height: C, side: 'corner', corner: 'bl' };
