			...
			>
				...
				{owner && (
					...
					>
						<span
							className="dot"
							style={{ background: owner.color, width: 10, height: 10 }}
						/>
				...
				{isOwner && (
					...
					>
						{canBuild && (
							<button
								className="btn sm"
								disabled={me.cash < def.houseCost}
								onClick={() => act('build', { pos })}
							>
			...
			<tbody>
				{rows.map((r, i) => {
					...
					return (
						...
						>
							<td style={{ padding: '4px 8px', borderRadius: on ? 4 : 0 }}>
								{r.label}
							</td>
...
function StationRent() {
	return (
		<table style={{ width: '100%', fontSize: 13 }}>
			<tbody>
				<tr>
					<td style={{ padding: '3px 8px' }}>1 owned</td>
					<td className="mono" style={{ textAlign: 'right', padding: '3px 8px' }}>
						$25
					</td>
				</tr>
				<tr>
					<td style={{ padding: '3px 8px' }}>2 owned</td>
					<td className="mono" style={{ textAlign: 'right', padding: '3px 8px' }}>
						$50
					</td>
				</tr>
				<tr>
					<td style={{ padding: '3px 8px' }}>3 owned</td>
					<td className="mono" style={{ textAlign: 'right', padding: '3px 8px' }}>
						$100
					</td>
				</tr>
				<tr>
					<td style={{ padding: '3px 8px' }}>4 owned</td>
					<td className="mono" style={{ textAlign: 'right', padding: '3px 8px' }}>
						$200
					</td>
				</tr>
...
function UtilityRent() {
	return (
		<div style={{ fontSize: 13, color: 'var(--text-2)', lineHeight: 1.6 }}>
			One owned: pay <b className="mono">4×</b> dice roll.
			<br />
